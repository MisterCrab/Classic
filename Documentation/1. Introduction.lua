...
* [2] is AntiFake Interrupt rotation 	( @target, @mouseover, @targettarget, @focustarget; 													supports: racial and class's interrupts			                                 )
* [3] is Rotation 						( @target, @mouseover, @targettarget, @focustarget; 													supports: all actions + Universal1-10			                                 )
* [4] is Secondary rotation 			( @target, @mouseover, @targettarget, @focustarget; 													supports: all actions + Universal1-10			                                 )
